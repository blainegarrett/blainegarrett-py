...
urlpatterns += patterns('views',
    ...
    url(r'^tinymcetest/$', views.tinymcetest.as_view(), name=views.tinymcetest.view_name),
    url(r'^blog_image/(?P<blob_key>[A-Za-z0-9-_:=]+)/$', views.BlogPrimaryImageDisplay.as_view(), name=views.BlogPrimaryImageDisplay.view_name),
    url(r'^(?P<category_slug>[\w-]+)/$', views.BlogCategoryCtrl.as_view(), name=views.BlogCategoryCtrl.view_name),
)